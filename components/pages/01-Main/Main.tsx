...
import icon_right from '@/assets/images/icons/icon_right.svg';
import icon_search from '@/assets/images/icons/icon_search_36.svg';
...
const CommunityBox = () => {
    return (
        <Link to="/postlist" className="block">
            <div
                className="mb-5 flex h-140px w-335px flex-col gap-20px rounded-20px border border-black p-5 transition-all duration-300 hover:cursor-pointer hover:shadow-lg">
