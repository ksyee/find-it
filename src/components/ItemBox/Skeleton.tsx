const Skeleton = () => {
  return (
    <div className="mb-3 flex h-[140px] w-[335px] items-center justify-between rounded-2xl bg-white pr-[10px] pl-[20px] shadow">
      ...
      <div className="animate-shimmer h-[120px] w-[120px] animate-pulse rounded-xl bg-slate-200"></div>
    </div>
  );
};
