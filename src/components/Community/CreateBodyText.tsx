    ...
    <>
      <form className="flex w-[315px] flex-col pt-[10px]">
        <input
          ...
          className="mt-[10px] w-full text-2xl tracking-tight text-black"
          style={{ outline: "none" }}
          maxLength={24}
          value={titleValue}
        ...
        <textarea
          ...
          className="mb-[24px] mt-[12px] w-full whitespace-normal break-keep text-base leading-28px tracking-tight text-gray-700"
      ...
      <input
        ...
        className="mb-[40px] mt-[20px]  flex w-[315px] text-base tracking-tight text-black"
        style={{ outline: "none" }}
        maxLength={15}
        value={tagValue}
